...
@Mixin(Entity.class)
public abstract class EntityMixin implements Gravity {
    private Direction gravity_direction = Direction.DOWN;
    private Direction entity_direction = Direction.DOWN;
    ...
    public void setDeltaMovement(Vec3 deltaMovement) {
        if (this.entity_direction == this.gravity_direction){
        ...
        this.entity_direction = this.gravity_direction;
    }
