...
@Mod(StarminerReborn.MOD_ID)
public class StarminerReborn {
    public static final String MOD_ID = "starminerreborn";
    public static final Logger LOGGER = LogUtils.getLogger();

    public StarminerReborn(IEventBus modEventBus, ModContainer modContainer) {
        // Register the commonSetup method for modloading
        modEventBus.addListener(this::commonSetup);

        // Register ourselves for server and other game events we are interested in.
        // Note that this is necessary if and only if we want *this* class
        // (StarminerReborn) to respond directly to events.
