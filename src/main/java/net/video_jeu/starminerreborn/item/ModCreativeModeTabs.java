...
public class ModCreativeModeTabs {
	public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TAB = 
			DeferredRegister.create(Registries.CREATIVE_MODE_TAB, StarminerReborn.MOD_ID);
	
	public static final Supplier<CreativeModeTab> STARMINER_REBORN_TAB = CREATIVE_MODE_TAB.register("starminer_reborn_tab",
